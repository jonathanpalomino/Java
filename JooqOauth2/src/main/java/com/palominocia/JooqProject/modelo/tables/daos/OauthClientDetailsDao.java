...
public class OauthClientDetailsDao extends DAOImpl<OauthClientDetailsRecord, com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails, String> {

    /**
     * Create a new OauthClientDetailsDao without any configuration
     */
    public OauthClientDetailsDao() {
        super(OauthClientDetails.OAUTH_CLIENT_DETAILS, com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails.class);
    }
    ...
    public OauthClientDetailsDao(Configuration configuration) {
        super(OauthClientDetails.OAUTH_CLIENT_DETAILS, com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails.class, configuration);
    }
     ...
     */
    @Override
    protected String getId(com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails object) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByClientId(String... values) {
     ...
     */
    public com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails fetchOneByClientId(String value) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByResourceIds(String... values) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByClientSecret(String... values) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByScope(String... values) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByAuthorizedGrantTypes(String... values) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByWebServerRedirectUri(String... values) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByAuthorities(String... values) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByAccessTokenValidity(Integer... values) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByRefreshTokenValidity(Integer... values) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByAdditionalInformation(String... values) {
     ...
     */
    public List<com.palominocia.JooqProject.modelo.tables.pojos.OauthClientDetails> fetchByAutoapprove(String... values) {
