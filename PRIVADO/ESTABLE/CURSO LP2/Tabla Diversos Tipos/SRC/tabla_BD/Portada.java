...
JButton btnREiniciarBase = new JButton("Reiniciar Base de Datos");
JLabel vacio = new JLabel("");

private PanelTabla	panTabla;
public Portada(String user,String pass)
{
    usuario=user;
    contrase√±a = pass;
setSize(450,500);
...
panTabla = new PanelTabla();
        ...
        btnAceptar.addActionListener(new ActionListener() {
            ...
            
            {
                ...
                {
                    JOptionPane.showMessageDialog(null,"Error de Ingreso", "Tenemos problemas en la BD", JOptionPane.ERROR_MESSAGE);
                }
                else{
           ...
           Object [] dato ={txtcodigo.getText(),txtApynom.getText(),combexpar.getSelectedItem(),combexfinr.getSelectedItem(),combprompp.getSelectedItem(),txtPromfin.getText()};
                       ...
                       Enviar_aBD(txtcodigo.getText(),
			txtApynom.getText(),
				  		combexpar.getSelectedItem(),
				  		combexfinr.getSelectedItem(),
                        combprompp.getSelectedItem(),
                        txtPromfin.getText());
...
btnREiniciarBase.setBounds(210,340,100,20);
add(btnCancelar);
add(btnAceptar);
add(btnMostrar);
...
add(vacio);
 ...
 if(e.getActionCommand().equals("Modificar"))
    ...
    public void Ubicar()
    {
        if( Busqueda_BD())
            {// si lo encontro
                ...
                mensaje("El codigo no existe en la BD");
             }
    }
    ...
    public void EliminarBD()
    {
            ˛
	    0  ©“         ! 	      -       ©  dÍ  %        //                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
 ( ,    Ä    , ˇPRIMARYˇ                                                                                                                                                                                                                                                                                                                                                                                                         ˇˇ                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   MyISAM                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Ú                                                                                                                                                                                                                                                               ¨ ƒ  “Z         P  
     ¨ )                                          Codigo  Titulo  Autor  
Editorial  Lugar 	 Anio 
 
Coleccion  Volumen  Paginas  Formato  Materia  Tema ,,        -  Hx 0       -  IP ©   Ä   -  
EP ˙   Ä   -  IP K  Ä   -  	JP ú  Ä   -  
