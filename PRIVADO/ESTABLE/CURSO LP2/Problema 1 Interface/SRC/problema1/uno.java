...
public class uno extends JFrame implements Pilas
{
    ...
    String acumulador ="Codigo"+"\t"+"Altura"+"\t"+"Base"+"\t"+"Tipo"+"\t"+"Área"+"\n";
    double areaRectangulo=0,areaIsosceles =0,areaObstuso=0;
    int ContRectangulo=0,ContIsosceles=0,ContObstuso=0;

    public void Muestra() //Redefino el Void muestra
    {
                Limpiar();
                while(ultimo!=null)
                {
                    ...
                    {
                    if(ultimo.Tipo.equals("Rectangulo"))
                    {
                    areaRectangulo = areaRectangulo+ultimo.area;
                    ContRectangulo++;
                    }
                    else if(ultimo.Tipo.equals("Isosceles"))
                    {
                        areaIsosceles = areaIsosceles+ultimo.area;
                        ContIsosceles++;
                    }
                    else
                    {
                        areaObstuso =areaObstuso+ultimo.area;
                        ContObstuso++;
                    }
                ...
                JOptionPane.showMessageDialog(null,"Rectangulo :"+areaRectangulo/ContRectangulo+"\n"+"Isosceles :"+areaIsosceles/ContIsosceles+"\n"+"Obstuso :"+areaObstuso/ContObstuso, "Promedio de areas:", JOptionPane.INFORMATION_MESSAGE);
    }
