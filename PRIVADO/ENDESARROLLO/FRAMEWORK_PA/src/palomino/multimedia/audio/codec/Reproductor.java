...
public class Reproductor implements Controlador, Runnable
{
    ...
    /**
	 * @uml.property  name="mi_hilo"
	 */
    protected Thread mi_hilo = null;
    /**
	 * @uml.property  name="mi_fuente_de_Datos"
	 */
    protected Object mi_fuente_de_Datos;
    /**
	 * @uml.property  name="m_encodedaudioInputStream"
	 * @uml.associationEnd  
	 */
    protected AudioInputStream m_encodedaudioInputStream;
    /**
	 * @uml.property  name="encodedLength"
	 */
    protected int encodedLength = -1;
    /**
	 * @uml.property  name="m_audioInputStream"
	 * @uml.associationEnd  
	 */
    protected AudioInputStream m_audioInputStream;
    /**
	 * @uml.property  name="m_audioFileFormat"
	 * @uml.associationEnd  
	 */
    protected AudioFileFormat m_audioFileFormat;
    /**
	 * @uml.property  name="m_line"
	 * @uml.associationEnd  
	 */
    protected SourceDataLine m_line;
    /**
	 * @uml.property  name="m_gainControl"
	 * @uml.associationEnd  
	 */
    protected FloatControl m_gainControl;
    /**
	 * @uml.property  name="m_panControl"
	 * @uml.associationEnd  
	 */
    protected FloatControl m_panControl;
    /**
	 * @uml.property  name="m_mixerName"
	 */
    protected String m_mixerName = null;
    /**
	 * @uml.property  name="m_lineCurrentBufferSize"
	 */
    private int m_lineCurrentBufferSize = -1;
    /**
	 * @uml.property  name="lineBufferSize"
	 */
    private int lineBufferSize = -1;
    /**
	 * @uml.property  name="threadSleep"
	 */
    ...
    /**
     * @see javazoom.Reproductor_1.Codec.Reproductor.BasicController#seek(long)
     */
    ...
    /**
     * @see javazoom.Reproductor_1.Codec.Reproductor.BasicController#play()
     */
    ...
    /**
     * @see javazoom.Reproductor_1.Codec.Reproductor.BasicController#stop()
     */
    ...
    /**
     * @see javazoom.Reproductor_1.Codec.Reproductor.BasicController#pause()
     */
    ...
    /**
     * @see javazoom.Reproductor_1.Codec.Reproductor.BasicController#resume()
     */
