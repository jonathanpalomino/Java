...
public class Archivo_Jalar_Pegar
{
    ...
    /**
	 * @uml.property  name="dropListener"
	 */
...
/* ********  I N N E R   C L A S S  ******** */
    ...
    /**
	 * This is the event that is passed to the {@link FileDropListener#filesDropped  filesDropped(...)}  method in your  {@link FileDropListener}  when files are dropped onto a registered drop target. <p>I'm releasing this code into the Public Domain. Enjoy.</p>
