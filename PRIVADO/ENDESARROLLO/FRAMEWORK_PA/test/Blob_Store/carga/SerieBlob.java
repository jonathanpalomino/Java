...
public class SerieBlob implements Blob, Serializable, Cloneable {
     ...
     */
    public SerieBlob(byte[] b) throws SerialException, SQLException {
     ...
     * @see java.sql.Blob
     */
    public SerieBlob (Blob blob) throws SerialException, SQLException {
