...
public class Agregar extends javax.swing.JFrame{
    ...
    Agregar(String url_Servidor, Libreria obje) {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(btnEliminar)
                        .addGap(18, 18, 18)
                        .addComponent(btnGuardarDatos, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)))
                .addGap(23, 23, 23)
...
//System.out.println(evt);
    ...
    private void Activar_Contenedor(Container c) {
        ...
        for (int i = 0; i < components.length; i++) {
            ...
            if (components[i] instanceof Container) {
                Activar_Contenedor((Container) components[i]);
            }
        }
    }
