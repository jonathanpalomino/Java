...
public class Consulta extends javax.swing.JFrame{
    ...
    Consulta(String url_Servidor, Libreria obje) {
        if (url_Servidor.contains("jdbc:sqlserver")) {
            obje.Setdriver_sql();
            enlace = obje.getEnlace();
        }
        else if (url_Servidor.contains("jdbc:mysql")) {
            obje.Setdriver_mysql();
            enlace = obje.getEnlace();
        }
        else if (url_Servidor.contains(".mdb")) {
    ...
    private void initComponents() {
        ...
        Menu_Eliminar.setToolTipText("Consulte primero si existe el usuario");
        Menu_Eliminar.setEnabled(false);
