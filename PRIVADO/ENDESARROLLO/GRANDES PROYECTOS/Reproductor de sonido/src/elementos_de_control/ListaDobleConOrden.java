...
public class ListaDobleConOrden{
	...
	// constructor
	public ListaDobleConOrden(){inicio=null; fin=null;}

	// get/set
	public void setInicio(NodoDoble inicio){this.inicio=inicio;	}
	public void setFin(NodoDoble fin){this.fin=fin;	}
	public NodoDoble getInicio(){return inicio;	}
	public NodoDoble getFin(){ return fin;	}
