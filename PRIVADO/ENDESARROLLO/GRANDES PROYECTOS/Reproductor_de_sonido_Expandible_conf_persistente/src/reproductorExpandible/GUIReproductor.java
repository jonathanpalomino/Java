...
//cargar archivo de configuracion
	...
	catch(java.lang.UnsupportedOperationException eh){
	JOptionPane.showMessageDialog(this, "El sistema no soporta ninguna operacion.", "Error", JOptionPane.ERROR_MESSAGE);
	}
