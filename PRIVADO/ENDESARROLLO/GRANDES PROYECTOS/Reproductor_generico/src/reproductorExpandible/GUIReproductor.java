...
public class GUIReproductor extends javax.swing.JFrame implements ReproductorLanzador {
    ...
    private void initComponents() {
        ...
        EliminarIrreDespues = new javax.swing.JRadioButtonMenuItem();
        ...
        Modo_Pres = new javax.swing.JCheckBoxMenuItem();
        ...
        btnVideo.setToolTipText("Lista de Musica");
        ...
        EliminarIrreDespues.setText("Eliminar Irreproducibles Despues");
        EliminarIrreDespues.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EliminarIrreDespuesActionPerformed(evt);
            }
        });
        OpcionLista.add(EliminarIrreDespues);
        ...
        Modo_Pres.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P, java.awt.event.InputEvent.CTRL_MASK));
        Modo_Pres.setText("Modo Presentacion");
        Modo_Pres.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Modo_PresActionPerformed(evt);
            }
        });
        MenuOpciones.add(Modo_Pres);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnVideo, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(Progreso1, javax.swing.GroupLayout.DEFAULT_SIZE, 456, Short.MAX_VALUE)
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(txtInformacion, javax.swing.GroupLayout.DEFAULT_SIZE, 456, Short.MAX_VALUE)
                .addContainerGap(10, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnVideo, javax.swing.GroupLayout.Alignment.TRAILING, 0, 0, Short.MAX_VALUE)
    ...
    private void PermitirIrreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PermitirIrreActionPerformed
        ...
        EliminarIrreDespues.setSelected(false);
    ...
    private void EliminarIrreDespuesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarIrreDespuesActionPerformed
        Tabla.BuscarIrreproducibles();
        EliminarIrreAuto.setSelected(true);
        noreproducible = true;
        EliminarIrreDespues.setSelected(false);
        PermitirIrre.setSelected(false);
    }//GEN-LAST:event_EliminarIrreDespuesActionPerformed

    private void Modo_PresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Modo_PresActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Modo_PresActionPerformed
...
// TODO Auto-generated catch block
    ...
    private javax.swing.JRadioButtonMenuItem EliminarIrreDespues;
    ...
    private javax.swing.JCheckBoxMenuItem Modo_Pres;
    ...
    public void ABRIR(String tipo) {
        ...
        FileNameExtensionFilter filtrovideo = new FileNameExtensionFilter("Video", "avi");
        archivo.setFileFilter(filter);
        archivo.setFileFilter(filtrovideo);
    ...
    public void ProgresarBarra(File tamañoarchivo, int progreso) {
        ...
        if (Progreso1.getValue() >= 99 && Modo_Pres.isSelected() == false) {
            ...
            Progreso1.setValue(0);
        } else if (Progreso1.getValue() >= 10 && Modo_Pres.isSelected()) {
            if (repetir && Pista == (tabla.getMiTabla().getRowCount() - 1)) {
                Reproducir(0);
            } else {
                SiguienteAnterior(1, control1);
