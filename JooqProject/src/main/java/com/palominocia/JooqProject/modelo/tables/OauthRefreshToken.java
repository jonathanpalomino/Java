...
import com.palominocia.JooqProject.modelo.tables.records.OauthRefreshTokenRecord;
...
public class OauthRefreshToken extends TableImpl<OauthRefreshTokenRecord> {
    ...
    private static final long serialVersionUID = -1458382363;

    /**
     * The reference instance of <code>autentificacion.oauth_refresh_token</code>
     */
    ...
    /**
     * The column <code>autentificacion.oauth_refresh_token.token_id</code>.
     */
    ...
    /**
     * The column <code>autentificacion.oauth_refresh_token.token</code>.
     */
    public final TableField<OauthRefreshTokenRecord, byte[]> TOKEN = createField("token", org.jooq.impl.SQLDataType.BLOB, this, "");

    /**
     * The column <code>autentificacion.oauth_refresh_token.authentication</code>.
     */
    ...
    /**
     * Create a <code>autentificacion.oauth_refresh_token</code> table reference
     */
    ...
    /**
     * Create an aliased <code>autentificacion.oauth_refresh_token</code> table reference
     */
